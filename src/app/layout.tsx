...
import { JetBrains_Mono, Inter, Workbench } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body
        className={`${jetbrainsMono.variable} ${inter.variable} ${workbench.variable} font-sans antialiased min-h-screen flex flex-col`}
      >
        <Header />
