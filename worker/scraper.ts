...
const THEMES_JSON_URL =
  "https://raw.githubusercontent.com/limehawk/omarchy-theme-website/main/src/data/themes.json";
...
async function fetchThemesRegistry(): Promise<ThemesRegistry> {
  ...
  return res.json() as Promise<ThemesRegistry>;
}
